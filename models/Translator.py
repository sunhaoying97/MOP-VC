...
class Translator_ARFormer(object):
        ...
        with torch.no_grad():
            ...
            for index, model in enumerate(models):
                ...
                if isinstance(batch['feats'][0], list):
                    ...
                    encoding_phase_outputs = model.encoding_phase(batch['feats'], batch=batch)
    ...
    def beam_decode_step(self, models, inst_dec_beams, len_input_ids, 
            all_inputs_for_decoder, all_decoder_rnn_hidden_states, inst_idx_to_position_map, **kwargs):
        ...
        word_probs, all_decoder_rnn_hidden_states = self.predict_word(
            models, input_ids, all_inputs_for_decoder, all_decoder_rnn_hidden_states, n_active_inst, **kwargs)
    ...
    def predict_word(self, models, input_ids, all_inputs_for_decoder, all_decoder_rnn_hidden_states, n_active_inst, **kwargs):
        word_probs = []
